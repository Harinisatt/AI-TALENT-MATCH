      ...
      <CardContent className="p-6 custom-scrollbar max-h-[800px] overflow-y-auto">
        <div className="flex items-center justify-between mb-3">
          <div className="flex items-center">
            <div className="flex-shrink-0 w-16 h-16 rounded-full bg-black flex items-center justify-center shadow-md mr-4 border-2 border-white">
              <div className="text-white font-bold text-xl tracking-tight">
                <div className="tracking-normal">
                  <span className="font-black" style={{ letterSpacing: "-1px" }}>WTA</span>
                </div>
              </div>
            </div>
            <div>
